...
<required_reading>
@$HOME/.codex/get-shit-done/references/verification-overrides.md
...
@$HOME/.codex/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@$HOME/.codex/get-shit-done/references/few-shot-examples/verifier.md
