...
<required_reading>
@$HOME/.codex/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@$HOME/.codex/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks $HOME/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = $HOME/.codex/get-shit-done
                  → writes to $HOME/.codex/get-shit-done/hooks/
...
@$HOME/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @$HOME/.codex/get-shit-done/references/common-bug-patterns.md
