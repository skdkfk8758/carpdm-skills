---
name: claude-ship
description: Imported Claude skill for shipping skill repository changes through PR, CI, approval, and cleanup.
---
...
(`/Users/carpdm/.codex/skills/claude-craft-core/references/output-contract.md` L1 — 전 스킬 공통,
