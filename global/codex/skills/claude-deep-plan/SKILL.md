---
name: claude-deep-plan
description: Imported Claude skill for producing a verified implementation plan and optional HTML companion without building code.
---
...
- 인터뷰 기법·grounding: `/Users/carpdm/.codex/skills/claude-craft-core/references/socratic.md`
- 문서 grounding(ADR/concept/guide): `/Users/carpdm/.codex/skills/claude-craft-core/references/context-adr.md`
- plan 섹션 + **HTML companion 규칙**: `/Users/carpdm/.codex/skills/claude-craft-core/references/pipeline.md`
  의 Phase 1 (특히 `.html` companion 분기 — UI 면 결과 UI 목업, 비UI 면 plan 렌더)
- 모호할 때의 측정 게이트·여섯 Socratic 유형: `/Users/carpdm/.codex/skills/claude-deep-interview/references/scoring.md`
  와 `/Users/carpdm/.codex/skills/claude-deep-interview/references/socratic-playbook.md`
- 종료 시 result 블록 규격(전 스킬 공통): `/Users/carpdm/.codex/skills/claude-craft-core/references/output-contract.md`
- 다음 스킬 추천 규격(deep-* 공통): `/Users/carpdm/.codex/skills/claude-deep-interview/references/next-skill-routing.md`
- PLAN → Linear 이슈 트리 등록 + MCP 감지/스킵: `/Users/carpdm/.codex/skills/claude-craft-core/references/linear.md` (Step 4.5 의 Linear 분기에서 차용 — 복제 금지)
- DB/BE plan 의 ERD 시안 생성법: `/Users/carpdm/.codex/skills/claude-erd/SKILL.md` + `assets/erd-template.html` + `references/schema-discovery.md` (Step 3 의 ERD 분기에서 차용 — 복제 금지)
...
말고 `/Users/carpdm/.codex/skills/claude-craft-core/references/pipeline.md` Phase 1 (SSOT) 을 따른다.
...
`/Users/carpdm/.codex/skills/claude-erd/SKILL.md` + `assets/erd-template.html` + `references/schema-discovery.md`.
...
메커니즘은 복제하지 말고 **`/Users/carpdm/.codex/skills/claude-craft-core/references/linear.md` 를 읽어
