---
name: claude-handoff
description: Imported Claude skill for saving or resuming session state across context boundaries.
---
...
작성 후, `/Users/carpdm/.codex/skills/claude-craft-core/references/output-contract.md` 의 종료 블록으로
