---
name: claude-linear-groom
description: Imported Claude skill for grooming Linear backlogs into grouped, build-ready issues after approval.
---
...
## 보강 (M건)
| 이슈 | tier | 보강 요지 (배경/현황/범위/Acceptance 한 줄) |
|---|---|---|
| ADT-7 | empty | 벌크업로드 UI=AssetUploader, 다중 select+큐, Acc=N개 동시업로드 |
```
