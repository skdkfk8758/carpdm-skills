...
metadata:
  short-description: "Sync managed GSD skills across runtime roots so multi-runtime users stay aligned after an update"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gsd-sync-skills`.
- Treat all user text after `$gsd-sync-skills` as `{{GSD_ARGS}}`.
