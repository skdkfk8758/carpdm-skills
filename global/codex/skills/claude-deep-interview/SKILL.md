---
name: claude-deep-interview
description: Imported Claude skill for Socratic requirement clarification that produces a numbered implementation spec.
---
...
spec 을 쓴 직후 `/Users/carpdm/.codex/skills/claude-craft-core/references/output-contract.md` 의 고정
